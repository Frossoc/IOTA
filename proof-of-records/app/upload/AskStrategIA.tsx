...
const copy: Record<Lang, Copy> = {
  en: {
    ...
    guidedActionLabels: {
      ...
      viewProofSummary: "View Summary",
      viewDetails: "View Technical",
      openVerify: "Open Verify",
      exploreIntegrations: "Explore Integrations",
      exportProof: "Download Summary",
    },
    manualActionLabels: {
  ...
  fr: {
    ...
    guidedActionLabels: {
      ...
      generateProofNow: "Générer la proof",
      viewProofSummary: "Voir Summary",
      viewDetails: "Voir Technical",
      openVerify: "Ouvrir Verify",
      exploreIntegrations: "Explorer Integrations",
      exportProof: "Download Summary",
    },
    manualActionLabels: {
      ...
      technical: ["Voir Technical"],
      integrations: ["Explorer Integrations"],
    },
    options: {
      create: {
        label: "Create Proof",
  ...
  es: {
    ...
    guidedActionLabels: {
      ...
      viewProofSummary: "Ver Summary",
      viewDetails: "Ver Technical",
